...
export default {
  ...
  computed: {
    serviceData() {
      return this.$store.state.serviceManagement.services.data
    },
    allData() {
      return this.$store.state.serviceManagement.services.meta
    },
    paginationPageSize() {
    ...
    currentPage: {
      get() {
        // console.log(val)
          // this.$store.dispatch("serviceManagement/fetchServices", this.currentPagee).catch(err => { console.error(err) })
      },
      set(val) {
          // this.currentPagee = val ;
          this.$store.dispatch("serviceManagement/fetchServices", val).catch(err => { console.error(err) })
      }
    }
  },
  methods: {
