    ...
    <div id="user-data" v-if="user_data">
      ...
      <vx-card title="Account" class="mb-base">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col flex-1" id="account-info-col-1">
            <table>
              ...
              <tr>
                <td class="font-semibold">Phohne</td>
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              <tr>
                ...
                <td>{{ user_data.active ==1 ?'active' : 'inactive'}}</td>
              </tr>
              <tr>
        ...
        <div class="vx-row">
          ...
          <div class="vx-col" id="avatar-col">
            <div class="img-container mb-4">
              <img :src="user_data.foodSystem.image" class="rounded w-full" />
            </div>
          </div>
          ...
          <div class="vx-col flex-1" id="account-info-col-1">
            <table>
              <tr>
                ...
                <td>{{ user_data.foodSystem.height }}</td>
              </tr>
              <tr>
                <td class="font-semibold">Weight	</td>
                <td>{{ user_data.foodSystem.weight	 }}</td>
              </tr>
              <tr>
                <td class="font-semibold">preparing_food :?	</td>
                <td>{{ user_data.foodSystem.preparing_food	== 1 ? 'yes' : 'no' }}</td>
              </tr>
            </table>
          </div> 
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              <tr>
                <td class="font-semibold">starting time</td>
                <td>{{ user_data.foodSystem.starting_time }}</td>
              </tr>
              <tr>
                <td class="font-semibold">exercise golas</td>
                <td>{{ user_data.foodSystem.exercise_goals  }}</td>
              </tr>
              <tr>
                <td class="font-semibold">exercise interval</td>
                <td>{{ user_data.foodSystem.exercise_interval }}</td>
              </tr>
            </table>
          </div>
          <!-- /Information - Col 2 -->
  ...
  methods: {
    confirmDeleteRecord() {
      this.$vs.dialog({
        ...
        text: `You are about to delete "${this.user_data.displayName}"`,
