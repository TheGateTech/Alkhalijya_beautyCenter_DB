...
<template>
    <div id="extra-component-select-demo">
        <p class="mb-4"><a href="https://sagalbot.github.io/vue-select/" target="_blank" rel="nofollow">vue-select</a> is a native Vue.js select component that provides similar functionality to Select2. Read full documnetation <a href="https://sagalbot.github.io/vue-select/docs/" target="_blank" rel="nofollow">here</a></p>
