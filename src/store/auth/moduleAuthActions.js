...
export default {
    ...
    //     // Try to sigin
    //     firebase.auth().signInWithEmailAndPassword(payload.userDetails.username, payload.userDetails.password)
    ...
    //     firebase.auth().createUserWithEmailAndPassword(payload.userDetails.username, payload.userDetails.password)
    //         .then(() => {
    //             payload.notify({
    ...
    registerUserJWT({ commit }, payload) {
      ...
      return new Promise((resolve,reject) => {
        ...
        jwt.registerUser(displayName, username, password)
          .then(response => {
            // Redirect User
            router.push(router.currentRoute.query.to || '/')
